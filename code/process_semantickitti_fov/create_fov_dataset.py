...
if __name__ == "__main__":
    for seq in [8]:
        createFovDataset(
            src_root="/home/kishorsabarishg/Desktop/semantickitti/dataset_kitti/sequences/", # path to the original semantic-kitti dataset
            dst_root="/home/kishorsabarishg/Desktop/eval", # path to the generated semantic-kitti-fov dataset
            seq=seq
        )